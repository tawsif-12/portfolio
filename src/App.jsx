        ...
        <section id="about" className="about card">
          ...
          <div className="academic-details">
            ...
            <div className="education-item">
              ...
              <p className="institution">Ahsanullah University of Science & Technology</p>
            </div>
            <div className="education-item">
              <h4>Higher Secondary Certificate (HSC)</h4>
              <p className="institution">Chittagong College</p>
            </div>
            <div className="education-item">
              <h4>Secondary School Certificate (SSC)</h4>
              <p className="institution">Chittagong Govt. Boys' High School</p>
            </div>
          </div>
        </section>
          ...
          <div className="skills-grid">
            <div className="skill-item" title="React">
              <svg viewBox="0 0 128 128" width="50" height="50">
                <g fill="#61DAFB"><circle cx="64" cy="64" r="11.4"/><path d="M107.3 45.2c-2.2-.8-4.5-1.6-6.9-2.3.6-2.4 1.1-4.8 1.5-7.1 2.1-13.2-.2-22.5-6.6-26.1-1.9-1.1-4-1.6-6.4-1.6-7 0-15.9 5.2-24.9 13.9-9-8.7-17.9-13.9-24.9-13.9-2.4 0-4.5.5-6.4 1.6-6.4 3.7-8.7 13-6.6 26.1.4 2.3.9 4.7 1.5 7.1-2.4.7-4.7 1.4-6.9 2.3C8.2 50 1.4 56.6 1.4 64s6.9 14 19.3 18.8c2.2.8 4.5 1.6 6.9 2.3-.6 2.4-1.1 4.8-1.5 7.1-2.1 13.2.2 22.5 6.6 26.1 1.9 1.1 4 1.6 6.4 1.6 7.1 0 16-5.2 24.9-13.9 9 8.7 17.9 13.9 24.9 13.9 2.4 0 4.5-.5 6.4-1.6 6.4-3.7 8.7-13 6.6-26.1-.4-2.3-.9-4.7-1.5-7.1 2.4-.7 4.7-1.4 6.9-2.3 12.5-4.8 19.3-11.4 19.3-18.8s-6.8-14-19.3-18.8zM92.5 14.7c4.1 2.4 5.5 9.8 3.8 20.3-.3 2.1-.8 4.3-1.4 6.6-5.2-1.2-10.7-2-16.5-2.5-3.4-4.8-6.9-9.1-10.4-13 7.4-7.3 14.9-12.3 21-12.3 1.3 0 2.5.3 3.5.9zM81.3 74c-1.8 3.2-3.9 6.4-6.1 9.6-3.7.3-7.4.4-11.2.4-3.9 0-7.6-.1-11.2-.4-2.2-3.2-4.2-6.4-6-9.6-1.9-3.3-3.7-6.7-5.3-10 1.6-3.3 3.4-6.7 5.3-10 1.8-3.2 3.9-6.4 6.1-9.6 3.7-.3 7.4-.4 11.2-.4 3.9 0 7.6.1 11.2.4 2.2 3.2 4.2 6.4 6 9.6 1.9 3.3 3.7 6.7 5.3 10-1.7 3.3-3.4 6.6-5.3 10zm8.3-3.3c1.5 3.5 2.7 6.9 3.8 10.3-3.4.8-7 1.4-10.8 1.9 1.2-1.9 2.5-3.9 3.6-6 1.2-2.1 2.3-4.2 3.4-6.2zM64 97.8c-2.4-2.6-4.7-5.4-6.9-8.3 2.3.1 4.6.2 6.9.2 2.3 0 4.6-.1 6.9-.2-2.2 2.9-4.5 5.7-6.9 8.3zm-18.6-15c-3.8-.5-7.4-1.1-10.8-1.9 1.1-3.3 2.3-6.8 3.8-10.3 1.1 2 2.2 4.1 3.4 6.1 1.2 2.2 2.4 4.1 3.6 6.1zm-7-25.5c-1.5-3.5-2.7-6.9-3.8-10.3 3.4-.8 7-1.4 10.8-1.9-1.2 1.9-2.5 3.9-3.6 6-1.2 2.1-2.3 4.2-3.4 6.2zM64 30.2c2.4 2.6 4.7 5.4 6.9 8.3-2.3-.1-4.6-.2-6.9-.2-2.3 0-4.6.1-6.9.2 2.2-2.9 4.5-5.7 6.9-8.3zm22.2 21.1c-1.2-2-2.3-4.1-3.4-6.2-1.2-2.1-2.4-4.1-3.6-6-1.3.1 3.8.5 7.4 1.1 10.8 1.9-1.1 3.3-2.3 6.8-3.8 10.3zM35.8 14.7c1-.6 2.2-.9 3.5-.9 6 0 13.5 4.9 21 12.3-3.5 3.8-7 8.2-10.4 13-5.8.5-11.3 1.4-16.5 2.5-.6-2.3-1-4.5-1.4-6.6-1.8-10.5-.3-17.9 3.8-20.3zM19.4 65.5c-7.8-3-12.3-7.2-12.3-10.5s4.6-7.6 12.3-10.5c1.9-.7 3.9-1.3 6-1.9 1.2 4.2 2.9 8.7 4.9 13.3-2 4.6-3.6 9-4.9 13.3-2.1-.6-4.1-1.2-6-1.9zm28.8 48.8c-4.1-2.4-5.5-9.8-3.8-20.3.3-2.1.8-4.3 1.4-6.6 5.2 1.2 10.7 2 16.5 2.5 3.4 4.8 6.9 9.1 10.4 13-7.4 7.3-14.9 12.3-21 12.3-1.3 0-2.5-.3-3.5-.9zM96.3 93c1.7 10.5.3 17.9-3.8 20.3-1 .6-2.2.9-3.5.9-6 0-13.5-4.9-21-12.3 3.5-3.8 7-8.2 10.4-13 5.8-.5 11.3-1.4 16.5-2.5.6 2.3 1 4.5 1.4 6.6zm9-15.6c-2 .8-4.2 1.5-6.4 2.1-1.2-4.2-2.9-8.7-4.9-13.3 2-4.6 3.6-9 4.9-13.3 2.2.7 4.4 1.4 6.4 2.1 7.6 2.9 12.3 7.1 12.3 10.5s-4.7 7.6-12.3 10.5z"/></g>
              </svg>
            </div>
            ...
            <div className="skill-item" title="C++">
              <svg viewBox="0 0 128 128" width="50" height="50">
                <path fill="#D26383" d="M115.4 30.7L67.1 2.9c-.8-.5-1.9-.7-3.1-.7-1.2 0-2.3.3-3.1.7l-48 27.9c-1.7 1-2.9 3.5-2.9 5.4v55.7c0 1.1.2 2.4 1 3.5l106.8-62c-.6-1.2-1.5-2.1-2.4-2.7z"/><path fill="#9C033A" d="M10.7 95.3c.5.8 1.2 1.5 1.9 1.9l48.2 27.9c.8.5 1.9.7 3.1.7 1.2 0 2.3-.3 3.1-.7l48-27.9c1.7-1 2.9-3.5 2.9-5.4V36.1c0-.9-.1-1.9-.6-2.8l-106.6 62z"/><path fill="#fff" d="M85.3 76.1C81.1 83.5 73.1 88.5 64 88.5c-13.5 0-24.5-11-24.5-24.5s11-24.5 24.5-24.5c9.1 0 17.1 5 21.3 12.5l13-7.5c-6.8-11.9-19.6-20-34.3-20-21.8 0-39.5 17.7-39.5 39.5s17.7 39.5 39.5 39.5c14.6 0 27.4-8 34.2-19.8l-12.9-7.6zM97 66.2l.9-4.3h-4.2v-4.7h5.1L100 51h4.3l-1.2 6.1h3.8l1.2-6.1h4.3l-1.2 6.1h2.4v4.7h-3.3l-.9 4.3h4.2v4.7h-5.1l-1.2 6h-4.3l1.2-6h-3.8l-1.2 6h-4.3l1.2-6h-2.4v-4.7H97zm4.8 0h3.8l.9-4.3h-3.8l-.9 4.3z"/>
              </svg>
            </div>
            <div className="skill-item" title="Machine Learning">
              <svg viewBox="0 0 128 128" width="50" height="50">
                <path fill="#00ADD8" d="M27.35 80.52l10.68-6.17c.08-.04.11-.11.11-.19V56.84c0-.08-.03-.15-.11-.19l-10.68-6.17c-.08-.05-.16-.05-.24 0L16.45 56.65c-.08.05-.11.11-.11.19v17.32c0 .08.03.15.11.19l10.66 6.17c.08.05.17.05.24 0z"/><circle fill="#FFF" cx="27.23" cy="65.52" r="3.09"/><circle fill="#FFF" cx="39.46" cy="72.08" r="3.09"/><circle fill="#FFF" cx="15.01" cy="72.08" r="3.09"/><circle fill="#FFF" cx="27.23" cy="78.64" r="3.09"/><path fill="#00ADD8" d="M88.35 38.52l10.68-6.17c.08-.04.11-.11.11-.19V14.84c0-.08-.03-.15-.11-.19L88.35 8.48c-.08-.05-.16-.05-.24 0L77.45 14.65c-.08.05-.11.11-.11.19v17.32c0 .08.03.15.11.19l10.66 6.17c.08.05.17.05.24 0z"/><circle fill="#FFF" cx="88.23" cy="23.52" r="3.09"/><circle fill="#FFF" cx="100.46" cy="30.08" r="3.09"/><circle fill="#FFF" cx="76.01" cy="30.08" r="3.09"/><circle fill="#FFF" cx="88.23" cy="36.64" r="3.09"/><path fill="#00ADD8" d="M88.35 122.52l10.68-6.17c.08-.04.11-.11.11-.19V98.84c0-.08-.03-.15-.11-.19l-10.68-6.17c-.08-.05-.16-.05-.24 0L77.45 98.65c-.08.05-.11.11-.11.19v17.32c0 .08.03.15.11.19l10.66 6.17c.08.05.17.05.24 0z"/><circle fill="#FFF" cx="88.23" cy="107.52" r="3.09"/><circle fill="#FFF" cx="100.46" cy="114.08" r="3.09"/><circle fill="#FFF" cx="76.01" cy="114.08" r="3.09"/><circle fill="#FFF" cx="88.23" cy="120.64" r="3.09"/><path fill="#B6D3F2" d="M58.73 64L43.5 73.17c-.24.14-.24.49 0 .63l15.23 9.17c.24.14.54-.03.54-.32V64.32c0-.29-.3-.46-.54-.32z"/><path fill="#7CB9E8" d="M58.73 64L73.96 54.83c.24-.14.24-.49 0-.63L58.73 45.03c-.24-.14-.54.03-.54.32v18.33c0 .29.3.46.54.32z"/>
              </svg>
            </div>
          </div>
        </section>
