              ...
              const skills = [
                {
                  ...
                  svg: (
                    <svg viewBox="0 0 128 128" width="50" height="50">
                      <path fill="#E44D26" d="M19.5 114.7L8.1 0h111.8l-11.4 114.6-44.6 12.4z"/>
                      <path fill="#F16529" d="M64 117.2l36-10 9.8-109.7H64z"/>
                      <path fill="#EBEBEB" d="M64 66.7H44.2l-1.4-15.7H64V36.2H32.7l.4 4.7 4.1 46.2H64z"/>
                      <path fill="#fff" d="M64 66.7v15.7h17.1l-1.6 17.7-15.5 4.3v15.7l25.1-7 3.4-38.1z"/>
                    </svg>
                  )
                },
                {
                  ...
                  svg: (
                    <svg viewBox="0 0 128 128" width="50" height="50">
                      <path fill="#1572B6" d="M19.5 114.7L8.1 0h111.8l-11.4 114.6-44.6 12.4z"/>
                      <path fill="#33A9DC" d="M64 117.2l36-10 9.8-109.7H64z"/>
                      <path fill="#fff" d="M64 66.7H44.2l-1.4-15.7H64V36.2H32.7l.4 4.7 4.1 46.2H64z"/>
                      <path fill="#EBEBEB" d="M64 66.7v15.7h17.1l-1.6 17.7-15.5 4.3v15.7l25.1-7 3.4-38.1z"/>
                    </svg>
                  )
                },
                {
                ...
                },
                {
                  ...
                  svg: (
                    <svg viewBox="0 0 24 24" width="50" height="50" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 0C5.372 0 0 5.373 0 12c0 5.303 3.438 9.8 8.205 11.387.6.111.82-.261.82-.577 0-.285-.011-1.04-.017-2.042-3.338.726-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.085 1.84 1.237 1.84 1.237 1.07 1.834 2.809 1.304 3.495.997.108-.775.418-1.305.762-1.606-2.665-.304-5.466-1.334-5.466-5.931 0-1.31.469-2.381 1.236-3.221-.124-.303-.535-1.523.117-3.176 0 0 1.008-.322 3.301 1.23a11.52 11.52 0 013.003-.404c1.018.005 2.045.138 3.003.404 2.291-1.553 3.297-1.23 3.297-1.23.653 1.653.242 2.873.119 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.803 5.625-5.475 5.921.43.371.823 1.102.823 2.222 0 1.606-.015 2.898-.015 3.293 0 .319.216.694.825.576C20.565 21.796 24 17.299 24 12c0-6.627-5.373-12-12-12z" fill="#fff"/>
                    </svg>
                  )
                }
              ];
                ...
                skills.forEach((_, i) => {
                  timeouts.push(setTimeout(() => {
                    if (itemsRef.current[i]) {
                      itemsRef.current[i].classList.add('animated');
                    }
                  }, 500 + i * 600));
                });
